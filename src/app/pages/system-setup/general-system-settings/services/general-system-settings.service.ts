...
export class GeneralSystemSettingsService {
  ...
  updateGeneralSystemSettings(generalSystemSettings: any) {
    ...
    this.httpClient
      .put<any>(endPointUrl, generalSystemSettings, httpOptions)
      .subscribe((data) => {
        if (data) {
          this.generalSystemSettingsRepository.updateGeneralSystemSettings(
            data
          );
        }
      });
  ...
  addHoliday(holiday: Holiday) {
    ...
    this.httpClient
      .post<any>(endPointUrl, holiday, httpOptions)
      .subscribe((_data) => {

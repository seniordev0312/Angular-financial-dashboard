...
const routes: Routes = [
  ...
  },
  {
    ...
    loadChildren: () =>
      import('./management/treaty-management/treaty-management.module').then(
        (m) => m.TreatyManagementModule
      ),
    canLoad: [AutoLoginAllRoutesGuard],
  },
  {
  ...
  },
  {
    ...
    loadChildren: () =>
      import(
        './Insurance-underwriting/general-insurance-underwriting/general-insurance-underwriting.module'
      ).then((m) => m.GeneralInsuranceUnderwritingModule),
    canLoad: [AutoLoginAllRoutesGuard],
  },
  {
    ...
    loadChildren: () =>
      import(
        './Insurance-underwriting/life-insurance-underwriting/life-insurance-underwriting.module'
      ).then((m) => m.LifeInsuranceUnderwritingModule),
    canLoad: [AutoLoginAllRoutesGuard],
  },
  {
    ...
    loadChildren: () =>
      import(
        './Insurance-underwriting/medical-insurance-underwriting/medical-insurance-underwriting.module'
      ).then((m) => m.MedicalInsuranceUnderwritingModule),
    canLoad: [AutoLoginAllRoutesGuard],
  },
  {
    ...
    loadChildren: () =>
      import(
        './Insurance-underwriting/motor-insurance-underwriting/motor-insurance-underwriting.module'
  ...
  },
  {
    ...
    loadChildren: () =>
      import('./human-resources/payroll/payroll.module').then(
        (m) => m.PayrollModule
      ),
    canLoad: [AutoLoginAllRoutesGuard],
  },
  {
    ...
    loadChildren: () =>
      import(
        './accounting-and-finance/accounts-payable/accounts-payable.module'
      ).then((m) => m.AccountsPayableModule),
    canLoad: [AutoLoginAllRoutesGuard],
  },
  {
    path: ApplicationRoutes.AccountsReceivable,
    loadChildren: () =>
      import(
        './accounting-and-finance/accounts-receivable/accounts-receivable.module'
      ).then((m) => m.AccountsReceivableModule),
    canLoad: [AutoLoginAllRoutesGuard],
  },
  {
    path: ApplicationRoutes.Cashier,
    loadChildren: () =>
      import('./accounting-and-finance/cashier/cashier.module').then(
        (m) => m.CashierModule
      ),
    canLoad: [AutoLoginAllRoutesGuard],
  },
  {
    ...
    loadChildren: () =>
      import(
        './accounting-and-finance/finance-and-reporting/finance-and-reporting.module'
  ...
  },
  {
    ...
    loadChildren: () =>
      import(
        './accounting-and-finance/General-accounting/general-accounting/general-accounting.module'
  ...
  },
  {
    ...
    loadChildren: () =>
      import('./activity-log/activity-log/activity-log.module').then(
  ...
  },
  {
    ...
    loadChildren: () =>
      import(
        './correspondence/correspondence-management/correspondence-management.module'
  ...
  },
  {
    ...
    loadChildren: () =>
      import('@root/pages/entities/entities.module').then(
        (m) => m.EntitiesModule
      ),
    canLoad: [AutoLoginAllRoutesGuard],
  },
